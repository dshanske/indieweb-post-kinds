...
/**
 * From https://github.com/WebDevStudios/Taxonomy_Single_Term
 ...
 * $custom_tax_mb->set( 'context', 'side' );
 * $custom_tax_mb->set( 'metabox_title', __( 'Kind', 'indieweb_taxonomy' ) );
...
class Taxonomy_Single_Term {
	 ...
	 * @var boolean
	 */
	protected $force_selection = true;
