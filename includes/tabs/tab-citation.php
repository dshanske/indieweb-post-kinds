...
<div class="inside hidden">
    <p>Citation.</p>
      ...
      <input type="text" name="publication" id="publication" size="70" value="<?php ifset($kindmeta['publication']); ?>"/><br/>
			<label for="featured"><?php _e( 'Featured Image', 'Post kind' ); ?></label><br/>
      <input type="text" name="featured" id="featured" size="70" value="<?php ifset($kindmeta['featured']); ?>" />
     <br/>
		 <br/><br/>
		 <label for="cite_content"><?php _e( 'Summary', 'Post kind' ); ?></label><br/>
		 <textarea name="cite_content" id="cite_content" cols="70"><?php ifset($kindmeta['content']); ?></textarea>
    ...
    <div id="kindmetatab-author">
      ...
      <input type="text" name="author_name" id="author_name" size="70" value="<?php ifset($author['name']); ?>" />
      <br />
      <label for="name"><?php _e( 'Author Photo', 'Post kind' ); ?></label><br/>
      <input type="text" name="author_photo" id="author_photo" size="70" value="<?php ifset($author['photo']); ?>" />
      <br />
