...
class Kind_Taxonomy {
	...
	public static function get_strings() {
		$strings = array(
			...
			'trip'   => _x( 'Travel', 'Post kind' ),
			'itinerary' => _x( 'Itinerary', 'Post kind'),
	...
	public static function get_strings_plural() {
		$strings = array(
			...
			'trip'   => _x( 'Travels', 'Post kind' ),
			'itinerary' => _x( 'Itineraries', 'Post kind' ),
		'eat'   => _x( 'Eat', 'Post kind' ),
	...
	public static function get_verb_strings() {
		$strings = array(
			...
			'trip'   => _x( 'Traveled', 'Post kind' ),
			'itinerary' => _x( 'Traveled', 'Post kind' ),
